...
//		TopMarginOption = new ZLIntegerRangeOption("Options", "TopMargin", 0, 100, 0);
		TopMarginOption = new ZLIntegerRangeOption("Options", "TopMargin", 0, 100, 50);
...
//		new ZLIntegerRangeOption("Options", "FooterHeight", 8, 20, 9);
	...
	public final ZLIntegerRangeOption FooterHeightOption =
			new ZLIntegerRangeOption("Options", "FooterHeight", 8, 200, 35);
	
	public final ZLIntegerRangeOption TitlerHeightOption =
			new ZLIntegerRangeOption("Options", "TitlerHeight", 8, 200, 100);
	...
	public List<CancelActionDescription> getCancelActionsList() {
		...
		if (FBReader.context.getSharedPreferences("netbook", Context.MODE_PRIVATE).getBoolean("show_netbook", false)) {
