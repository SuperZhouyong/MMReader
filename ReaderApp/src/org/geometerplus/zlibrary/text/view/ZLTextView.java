...
//		Log.d("xxxx", "getParagraphIndex: "+ myCurrentPage.StartCursor.getParagraphIndex());
//		Log.d("xxxx", "getCharIndex: "+ myCurrentPage.StartCursor.getCharIndex());
//		Log.d("xxxx", "getElementIndex: "+ myCurrentPage.StartCursor.getElementIndex());			
		if(myCurrentPage.StartCursor.isStartOfText()) return false;
		
		
		return true;
//		if(myCurrentPage.StartCursor.getParagraphIndex() == 2) return true;
	}
}
