...
//		final int h = getMainAreaHeight();
	...
	private void simonDrawTitle(Canvas canvas){
//		canvas.drawBitmap(myFooterBitmap, 0, getHeight() - footer.getHeight(), myPaint);
//		Paint titlePaint = new Paint();
//		titlePaint.setTextSize(48f);
//		canvas.drawText("第一张", 100, 200, titlePaint);
		
		
		final ZLView view = ZLApplication.Instance().getCurrentView();
		final ZLView.TitleArea title = view.getTitleArea();
...
//		if (myFooterBitmap != null &&
//			(myFooterBitmap.getWidth() != getWidth() ||
//			 myFooterBitmap.getHeight() != title.getHeight())) {
//			myFooterBitmap = null;
//		}
//		if (myFooterBitmap == null) {
//			myFooterBitmap = Bitmap.createBitmap(getWidth(), title.getHeight(), Bitmap.Config.RGB_565);
//		}
		final ZLAndroidPaintContext context = new ZLAndroidPaintContext(
				canvas,
			getWidth(),
		...
		title.paint(context);
//		canvas.drawBitmap(myFooterBitmap, 0, getHeight() - title.getHeight(), myPaint);
	}
